...
```bash
conda create -n captus -c bioconda -c conda-forge -c jlsteenwyk "clipkit>=1.3.0" "python>=3.6" pandas plotly tqdm perl-bioperl-core=1.007002 bbmap falco fastqc mafft mmseqs2 megahit pigz vsearch
```
